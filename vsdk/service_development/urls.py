...
urlpatterns = [
	...
	url(r'^record_offer/(?P<element_id>[0-9]+)/(?P<session_id>[0-9]+)/$', views.record_of, name='record-offer'),
	url(r'^record_announcement/(?P<element_id>[0-9]+)/(?P<session_id>[0-9]+)/$', views.record_an, name='record-announcement'),
